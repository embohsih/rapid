    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RAPID-light"), QVariant("light"));
    //ui->theme->addItem(QString("RAPID-light-hires"), QVariant("light-hires"));
    //ui->theme->addItem(QString("RAPID-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("RAPID-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("RAPID-traditional"), QVariant("trad"));
