...
These denominations are 0.01 RAPID, 0.1 RAPID, 1 RAPID and 10 RAPID -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rapidpayc.atlassian.net/wiki/display/DOC/PrivateSend\">https://rapidpayc.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
