...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"")
            + HelpExampleRpc("validateaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"")
        );
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"]}")
        );
