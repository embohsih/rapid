...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", \"tabby\"")
        );
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"")
            + HelpExampleRpc("getaccount", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"")
        );
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", 6")
       );
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\\\":0.01,\\\"Rq8iSMDriTjNkqy3BscWyAC7Ztr8jFZZFm\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\\\":0.01,\\\"Rq8iSMDriTjNkqy3BscWyAC7Ztr8jFZZFm\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\\\":0.01,\\\"Rq8iSMDriTjNkqy3BscWyAC7Ztr8jFZZFm\\\":0.02}\", 6, false, \"testing\"")
        );
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\" 1.0") +
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\\\",\\\"Rq8iSMDriTjNkqy3BscWyAC7Ztr8jFZZFm\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"RshRkdfaa3u7m7w6FRaNYhV8xBkNytsSP8\\\",\\\"Rq8iSMDriTjNkqy3BscWyAC7Ztr8jFZZFm\\\"]\"")
        );
