...
git clone https://github.com/rapidpayc/rapid
```
...
```bash
    ...
    From https://github.com/rapidpayc/rapid
...
[rapid/gitian.sigs](https://github.com/rapidpayc/gitian.sigs/) repository, or if that's not possible to create a pull
request.
